...
function gamipress_bbp_activity_triggers( $triggers ) {
    ...
    $triggers[__( 'bbPress', 'gamipress-bbpress-integration' )] = array(
        'gamipress_bbp_new_forum'               => __( 'Create a new forum', 'gamipress-bbpress-integration' ),

        'gamipress_bbp_new_topic'               => __( 'Create a new topic', 'gamipress-bbpress-integration' ),
        'gamipress_bbp_specific_new_topic'      => __( 'Create a new topic on a specific forum', 'gamipress-bbpress-integration' ),

        'gamipress_bbp_new_reply'               => __( 'Reply to a topic', 'gamipress-bbpress-integration' ),
        ...
        'gamipress_bbp_delete_reply'            => __( 'Delete a reply', 'gamipress-bbpress-integration' ),
    );
