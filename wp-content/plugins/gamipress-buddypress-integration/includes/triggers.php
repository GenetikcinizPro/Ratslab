...
function gamipress_bp_activity_triggers( $triggers ) {
    ...
    $triggers[__( 'BuddyPress', 'gamipress-buddypress-integration' )] = array(
        ...
        'gamipress_bp_set_member_type' => __( 'Get assigned to a specific profile type', 'gamipress-buddypress-integration' ),
    );
    ...
    if ( gamipress_bp_is_active( 'friends' ) ) {
        $triggers[__( 'BuddyPress Friendships', 'gamipress-buddypress-integration' )] = array(
            ...
            'gamipress_bp_friendship_rejected'      => __( 'Reject a friendship request', 'gamipress-buddypress-integration' ),
            'gamipress_bp_get_friendship_rejected'  => __( 'Get a friendship request rejected', 'gamipress-buddypress-integration' ),
            'gamipress_bp_friendship_deleted'      => __( 'Remove a friendship', 'gamipress-buddypress-integration' ),
            'gamipress_bp_get_friendship_deleted'  => __( 'Get a friendship removed', 'gamipress-buddypress-integration' ),
        );
    }
    ...
    if ( gamipress_bp_is_active( 'activity' ) ) {
        $triggers[__( 'BuddyPress Activity', 'gamipress-buddypress-integration' )] = array(
            ...
            'gamipress_bp_new_activity_comment'             => __( 'Reply to an activity post', 'gamipress-buddypress-integration' ),
            'gamipress_bp_favorite_activity'                => __( 'Favorite an activity post', 'gamipress-buddypress-integration' ),
            'gamipress_bp_remove_favorite_activity'         => __( 'Remove a favorite on an activity post', 'gamipress-buddypress-integration' ),
            'gamipress_bp_user_favorite_activity'           => __( 'Get a favorite on an activity post', 'gamipress-buddypress-integration' ),
            'gamipress_bp_user_remove_favorite_activity'    => __( 'Get a favorite removed on an activity post', 'gamipress-buddypress-integration' ),
        );
    }
    ...
    switch( $requirement['trigger_type'] ) {
        ...
        case 'gamipress_bp_set_member_type':
            ...
            if( isset( $member_types[$bp_member_type] ) ) {
                return sprintf( __( 'Get assigned to the %s type', 'gamipress-buddypress-integration' ), $member_types[$bp_member_type]->labels['singular_name'] );
            }
            break;
