 ...
 * Versioning
 */
define('VIKINGER_VERSION', '1.9.7.3');
...
function vikinger_admin_load_scripts() {
  ...
  wp_enqueue_style('vikinger-admin-styles', VIKINGER_URL . '/css/admin-style.min.css', ['vikinger-admin-simplebar-styles'], '1.4.6');

  // add custom scripts
  wp_enqueue_script('vikinger-admin-scripts', VIKINGER_URL . '/js/admin.bundle.min.js', [], '3.9.6', true);
...
function vikinger_load_scripts() {
  ...
  wp_enqueue_style('vikinger-styles', VIKINGER_URL . '/style.css', ['vikinger-simplebar-styles', 'vikinger-swiper-slider-styles'], '3.9.6');
  ...
  // add main script
  wp_enqueue_script('vikinger-main-scripts', VIKINGER_URL . '/js/app.bundle.min.js', $vikinger_main_scripts_dependencies, '3.9.6', true);
